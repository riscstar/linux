 ...
 * @dwmac:		I/O mapped address used by dwmac
 * @emac_ctl:		I/O mapped address used for eMAC control
 * @pma_ctl:		I/O mapped address used for PMA control
 * @xpcs_regmap:	Regmap used for XPCS
 * @msigen_irq:		IRQ number used by MSIGEN
 * @xpcs_indirect:	XPCS regmap uses indirect addressing

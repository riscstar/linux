 ...
 * direction and output value registers for GPIOs 2 and 3 (0x0000000c).
 * These GPIOs control the reset signal for the two downstream PCIe
 * ports.  Those reset signals should never change while this driver
 * is operational.  We also reserve those two GPIOs.
 */
